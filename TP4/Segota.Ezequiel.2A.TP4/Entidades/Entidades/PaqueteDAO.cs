    ...
    public static class PaqueteDAO
    {
        ...
        public static bool Insertar(Paquete p)
        {
            ...
            try
            {
                ...
                PaqueteDAO.comando.CommandText = string.Format("INSERT INTO dbo.Paquetes ([direccionEntrega], [trackingID], [alumno]) values ('{0}','{1}','Ezequie Segota')", p.DireccionEntrega, p.TrackingID);  
